...
#to remove when using MYSQL via pythonanywhere
'''
DATABASES = {
    'default': {
...
'''
#to add when using MYSQL via pythonanywhere
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': 'thewhiteowl$ads',
        'USER': 'thewhiteowl',
        'PASSWORD': 'Pass123!',
        'HOST': 'thewhiteowl.mysql.pythonanywhere-services.com',
         'OPTIONS': {
